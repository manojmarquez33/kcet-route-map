    ...
    try {
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          // Filter data where type is "Classroom"
          filteredData =
              data.where((item) => item['type'] == 'Class').toList() ?? [];
        });
        return "Success!";
      } else {
        throw Exception(
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search your Classroom',
          ...
          : filteredData.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    // Use only "Classroom.png" image
                    String imagePath = 'assets/images/classroom.png';
